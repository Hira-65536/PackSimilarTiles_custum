...
d:number{ id="tile_w", label="Tile Width:", text="16", focus=true }
 ...
 :check { id="checker", label="It clears the existing tile", onclick=function() newTileCheck_flag = not newTileCheck_flag end}
